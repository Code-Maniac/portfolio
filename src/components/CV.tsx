...
const EDUCATION: EducationEntry[] = [
  {
    degree: 'BEng Electronic & Electrical Engineering',
...
const SKILL_BARS: SkillBar[] = [
  ...
  { label: 'ARM / RTOS Firmware', level: 90 },
  ...
  return (
    <div className="skill-bar">
      ...
      <div className="skill-bar-track">
        <div className="skill-bar-fill" style={{ '--w': `${level}%` } as React.CSSProperties} />
      </div>
    </div>
  )
}
  ...
  return (
    <section id="cv">
      ...
      <h2 className="section-heading">
        Where I've been.<br /><em>Where I'm going.</em>
      </h2>
