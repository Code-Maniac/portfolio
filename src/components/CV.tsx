...
const EXPERIENCE: ExperienceEntry[] = [
  {
    ...
    tags: ["Rust", "C", "C++", "STM32", "EFM-8", "Linux", "Embedded"],
  },
  {
    role: "Software Engineer",
    company: "Veethree Ltd",
    ...
    keyPoints: [
      "Programming and maintenance of software across a range of embedded Linux systems with a particular focus on CAN interfaces",
  ...
  {
    role: "Software Engineer",
    company: "James Fisher Prolec Ltd",
    ...
    keyPoints: [
      ...
      "Code review",
      "Technical support for professional customers and remote support for company service engineers",
      "Authoring specification and manual documents",
    ],
    tags: ["MISRA C++", "Safety-Critical", "Embedded"],
  },
  {
