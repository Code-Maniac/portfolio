        ...
        <main>
          ...
          <div className="scene-break">
            <div className="scene-break-inner">
              ...
              <p className="scene-break-sub">Low-level roots, expanding horizon</p>
            </div>
          </div>

          {/* About */}
          <div id="about" className="section-wrap" style={{ background: 'var(--surface-solid)' }}>
            <About />
          </div>
          ...
          {/* CV */}
          <div id="cv" className="section-wrap" style={{ background: 'var(--surface-solid)' }}>
            <CV />
          </div>
          ...
          {/* Projects */}
          <div id="projects" className="section-wrap" style={{ background: 'var(--surface-solid)' }}>
            <Projects />
          </div>
          ...
          {/* Games */}
          <div id="games" className="section-wrap" style={{ background: 'var(--surface-solid)' }}>
            <Games />
          </div>
        </main>
